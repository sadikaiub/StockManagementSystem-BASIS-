        ...
        private void ExportPdfButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Convert.ToInt32(companyComboBox.SelectedValue) < 1)
                {
                    ...
                    var path = @"H:\BITM\Basis Training Documents\StockManagementSystem-BASIS-\StockManagementSystem\Reports_" + DateTime.Now.ToString("dd'-'MM'-'yyyy'T'HH'-'mm'-'ss'GMT'") + ".pdf";
