        ...
        private void ExportPdfButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (flagExists)
                {
                    ...
                    var path = @"H:\BITM\Basis Training Documents\StockManagementSystem-BASIS-\StockManagementSystem\Reports" + DateTime.Now.ToString("dd'-'MM'-'yyyy'T'HH'-'mm'-'ss'GMT'") + ".pdf";
